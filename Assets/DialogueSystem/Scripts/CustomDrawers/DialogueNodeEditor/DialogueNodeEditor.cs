...
{
    private List<DialogueComponentNode> nodes;
    ...
    private void OnClickAddNode(Vector2 mousePosition)
    {
        if (nodes == null)
        {
            nodes = new List<DialogueComponentNode>();
        }

        nodes.Add(new DialogueComponentNode(mousePosition, 200, 50, nodeStyle, selectedNodeStyle, inPointStyle, outPointStyle, OnClickInPoint, OnClickOutPoint, OnClickRemoveNode));
    }
